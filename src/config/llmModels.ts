...
export function getTextModelsForProvider(provider: 'openai' | 'gemini'): ModelOption[] {
  return provider === 'openai' ? OPENAI_TEXT_MODELS : GEMINI_TEXT_MODELS;
}

export function getImageModelsForProvider(provider: 'openai' | 'gemini'): ModelOption[] {
  return provider === 'openai' ? OPENAI_IMAGE_MODELS : GEMINI_IMAGE_MODELS;
}

export function getVideoModelsForProvider(provider: 'openai' | 'gemini'): ModelOption[] {
