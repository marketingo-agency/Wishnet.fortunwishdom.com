/**
 * PSP-1 RSS feed builder (Plan 3 Phase 9, D-A6).
 *
 * Pure and unit-tested; the omni-podcast edge function carries a byte-equal
 * mirror in feed.ts (edge code cannot import src/). Keep BOTH in sync — the
 * client uses this one for the feed preview, the edge writes the real file.
 *
