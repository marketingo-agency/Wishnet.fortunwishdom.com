...
export function ScenarioWizard({ runId, onRunCreated, onExit }: ScenarioWizardProps) {
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      >
        <div className="mx-auto w-full max-w-3xl">
          ...
          {ordinal === 4 && scenario && (
            <ScenarioExport scenario={scenario} onFinish={() => void handleFinish()} finishing={finishing} />
          )}
          {ordinal > 1 && !scenario && (
