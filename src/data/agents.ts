...
export const AI_AGENTS: AgentMetadata[] = [
  ...
  },
  {
    ...
    description: 'Turns a topic or your Brain/Wishpedia sources into a fully scripted, multi-voice podcast episode — AI script, studio-quality AI voices via fal, show notes, and cover art.',
    icon: Mic,
    color: 'from-blue-500 to-indigo-600',
    gradient: 'from-blue-500/10 via-indigo-500/5 to-blue-600/10',
    glowColor: 'bg-blue-500/30',
    iconColor: 'text-blue-500',
    tags: ['Podcast', 'Audio', 'Script', 'Voice', 'AI Voices'],
    status: 'active',
